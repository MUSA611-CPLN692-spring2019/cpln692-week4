...
var query5;
var query5 = _.filter(bakedGoods, function(baked) {
  return baked.price > 4;
}
);
...
var query6;
var query6 = _.sortBy(bakedGoods, function(baked) {
  return baked.inventory;
}
);
...
var query7;
var query7 = _.groupBy(bakedGoods, function(baked) {
  return baked.type;
}
);
