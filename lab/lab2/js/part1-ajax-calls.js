/* =====================
  Lab 2, Part 1 - reviewing functions as values
...
_.each(theArray, function(data){console.log(logDouble(data))});
...
/* =====================
  Writing ajax calls works very much like these higher order functions.
  Here's the ajax syntax:
...
===================== */
var request = $.ajax("https://raw.githubusercontent.com/CPLN692-MUSA611/datasets/master/json/philadelphia-crime-snippet.json")
  .done(function(res){
    var parsed = JSON.parse(res);
    console.log(parsed);
    _.each(parsed,function(parsed){return L.marker([parsed.Lat, parsed.Lng]).bindPopup().addTo(map)})});
